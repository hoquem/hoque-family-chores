...
We do **not** sell or rent your information, we do **not** show advertising, and
...
**Diagnostics.** Firebase Crashlytics collects anonymized crash reports and basic
device information (device model, OS version) to help us fix bugs.
...
The App is built for families and is intended to be set up and managed by a
**parent or guardian**, who is responsible for the children in their family
group.
...
- We do **not** show advertising to children, and we do **not** use their data
  for advertising, profiling, or any purpose beyond running the family's chore
  activity.
- A parent or guardian can **view, correct, or delete** a child's data at any
  time from within the App or by contacting us.

We aim to comply with children's-privacy laws including the U.S. Children's
Online Privacy Protection Act (**COPPA**) and the UK/EU **GDPR** (including the
protections for children). If you believe a child has provided us information
without appropriate parental involvement, contact us and we will delete it.
...
We retain your data while your account is active. You can **delete your account
and its data from within the App** (Profile → Delete Account), or request
deletion by contacting us; requests are honored within **30 days**. Deleting an
account removes the associated profile and personal data; anonymized diagnostics
and aggregate usage counts that cannot identify you may be retained.

## Your Choices

- **Notifications:** turn on or off in the App or your device settings.
- **Photos:** photo proof is off by default and is a per-chore choice.
- **Analytics:** to opt out of usage analytics, contact us at the address below
  and we will disable collection for your family.
- **Access/deletion:** contact us to access or delete your data.

## Your Rights

Depending on where you live (e.g. under GDPR or similar laws), you may have the
right to access, correct, delete, restrict, or port your personal data, and to
...
by the "Last updated" date above and, where appropriate, notified in the App.

## Contact

For questions, data access, deletion, or analytics opt-out:
**m.hoque@gmail.com**
